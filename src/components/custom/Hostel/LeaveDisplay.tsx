...
export default function LeaveDisplay({ leaveData, handleHostelDetailsFetch }) {
 ...
 {activeLeave ? (
 <div className="max-w-xl mx-auto mb-4 border border-gray-300 dark:border-gray-700 rounded-2xl p-4 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 ">
 ...
 <table className="min-w-full border-collapse table-auto bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 ">
