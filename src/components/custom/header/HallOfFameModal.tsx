...
export default function HallOfFameModal({ handleClose }: { handleClose: () => void }) {
 ...
 className="fixed inset-0 z-[100] bg-gray-50/80 dark:bg-slate-900/80 backdrop-blur-3xl overflow-hidden flex flex-col"
 >
 {/* Ambient Glows */}
 <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
 <div className="absolute -top-[10%] -right-[5%] w-[60%] h-[60%] bg-amber-400/40 dark:bg-amber-500/30 rounded-full blur-[100px]" />
 <div className="absolute top-[30%] -left-[10%] w-[50%] h-[50%] bg-orange-500/40 dark:bg-orange-600/30 rounded-full blur-[100px]" />
 </div>
 ...
 <button 
 onClick={handleClose}
 className="p-2.5 bg-white/50 hover:bg-white dark:bg-slate-800/50 dark:hover:bg-slate-800 text-gray-700 dark:text-gray-300 rounded-full transition-all border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-md shadow-sm"
 >
 <ChevronLeft size={24} />
 </button>
 ...
 className="group block p-4 rounded-2xl bg-white/50 dark:bg-slate-800/50 hover:bg-white/80 dark:hover:bg-slate-800/80 border border-gray-100/50 dark:border-gray-700/30 transition-all cursor-pointer"
 >
 <div className="flex items-start justify-between">
 <div className="flex items-center gap-3 mb-3">
 <div className="p-2.5 bg-gray-100/80 dark:bg-slate-900/80 rounded-xl text-gray-700 dark:text-gray-300 group-hover:text-amber-500 group-hover:scale-110 transition-all">
 <Github size={22} />
 </div>
 <div>
 <h3 className="text-base font-bold text-gray-900 dark:text-white flex items-center gap-2 leading-tight">
 {credit.name}
 </h3>
 ...
 <div className="p-1.5 bg-gray-100/50 dark:bg-slate-800/50 rounded-full text-gray-400 group-hover:text-amber-500 group-hover:bg-amber-50 dark:group-hover:bg-amber-500/10 transition-colors">
 ...
 <div className="relative z-10 mt-10 mb-8 pt-6 border-t border-gray-200/50 dark:border-gray-800/50 text-center">
 <p className="text-sm font-medium text-gray-500 dark:text-gray-400 flex items-center justify-center gap-2">
 Curated with <Star size={16} className="text-amber-500" /> by <span className="text-gray-900 dark:text-white font-bold">SugeethJSA</span>
 </p>
 </div>
 </div>
 </div>
