...
export default function ChangelogModal({ handleClose }) {
 ...
 <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-lg max-h-[85vh] flex flex-col shadow-2xl border border-gray-200 dark:border-gray-800 animate-slideUp">
 ...
 {/* Timeline dot */}
 <div className="absolute left-0 top-1.5 w-[24px] h-[24px] rounded-full border-4 border-white dark:border-slate-900 bg-blue-500 shadow-sm flex items-center justify-center">
 ...
 <span className="text-sm font-medium text-gray-500 dark:text-gray-400 ">{release.date}</span>
 </div>
