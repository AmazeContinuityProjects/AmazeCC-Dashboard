...
export default function Links() {
 ...
 className="w-full flex items-center justify-between text-left text-xl font-semibold text-gray-800 dark:text-gray-200 hover:cursor-pointer"
 >
 <span>Links</span>
 {open ? (
 ...
 <div
 key={index}
 className="flex items-center justify-between px-4 py-3 bg-gray-200 dark:bg-slate-800 rounded-lg"
 >
 <span
 ...
 className="ml-3 p-2 rounded-md bg-gray-300 dark:bg-slate-700 hover:bg-gray-400 dark:hover:bg-slate-600 transition-colors"
 >
 {copiedIndex === index ? (
