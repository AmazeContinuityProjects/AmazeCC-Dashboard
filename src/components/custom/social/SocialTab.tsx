...
export default function SocialTab({ attendanceData }: { attendanceData: any }) {
 ...
 {/* Header */}
 <div className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
 ...
 {groups.length === 0 ? (
 <div className="col-span-full py-6 flex flex-col items-center justify-center text-center bg-white/40 dark:bg-slate-900/30 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 border-dashed rounded-2xl">
 ...
 className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-md transition-all flex flex-col cursor-pointer group"
 >
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
 {friends.length === 0 ? (
 <div className="col-span-full py-12 flex flex-col items-center justify-center text-center bg-white/40 dark:bg-slate-900/30 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 border-dashed rounded-2xl">
 ...
 className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-md transition-all flex flex-col cursor-pointer hover:border-blue-500/30"
 >
