...
<NavigationTabs
 ...
 <div 
 className={`relative bg-gray-50/50 dark:bg-gray-900/50 min-h-[100dvh] text-gray-900 dark:text-gray-100 transition-all duration-300 pb-24 md:pb-0 ${settings.isSidebarCollapsed ? 'md:pl-24' : 'md:pl-72'} w-full overflow-hidden`}
 ...
 <div>
 <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100 tracking-tight font-display">AmazeCC</h2>
 <h2 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-100 flex-1 truncate font-display">
 ...
 <button
  ...
  className="p-2.5 rounded-full bg-accent/10 text-accent hover:bg-accent/20 transition-colors shadow-small"
  title="Reload Data"
  >
