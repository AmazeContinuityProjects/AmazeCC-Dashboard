...
export default function PapersArchiveTab({ allGradesData, marksData, username, setActiveSubTab }: { allGradesData: any; marksData: any; username: string; setActiveSubTab?: (tab: string) => void }) {
 ...
 const papersRes = await apiFetch('/api/qbank/papers?course=' + encodeURIComponent(course.code));
 ...
 const questionsRes = await apiFetch('/api/qbank/questions?course=' + encodeURIComponent(course.code));
 ...
 {setActiveSubTab && (
 <button onClick={() => setActiveSubTab("overview")} className="hidden md:block p-2 rounded-full bg-white dark:bg-slate-800 shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-100">
 <ArrowLeft size={20} />
 </button>
 )}
 <div>
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
 />
 </div>
 ...
 className="group flex items-center justify-between p-4 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md transition-all text-left"
 >
 ...
 <div className="flex bg-gray-100 dark:bg-slate-800 rounded-lg p-1 w-full md:w-max mb-6">
 <button
 ...
 className="group p-4 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700 transition-all"
 >
