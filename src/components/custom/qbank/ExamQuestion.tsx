...
export default function ExamQuestion({ question, index }) {
 ...
 return (
 <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 transition-colors">
 {/* Header */}
 <div className="flex justify-between items-start mb-4">
 <div className="flex items-center gap-2 flex-wrap">
 <span className="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 text-xs font-bold px-2.5 py-1 rounded-md">
 Q{index + 1}
 </span>
 {question.question_type && (
 <span className="bg-purple-50 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400 text-xs px-2 py-1 rounded-md font-medium">
 {question.question_type}
 </span>
 )}
 {question.topic_name && (
 <span className="bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400 text-xs px-2 py-1 rounded-md">
 {question.topic_name}
 </span>
 )}
 {question.source_type && (
 <span className="bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-400 text-xs px-2 py-1 rounded-md font-medium border border-green-200 dark:border-green-800/40">
 ...
 {selectedOption && (
 <button onClick={handleReset} className="p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="Reset">
 ...
 else btnClass = "border-gray-200 dark:border-gray-700 opacity-40";
 }
 ...
 >
 <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 text-sm font-semibold text-gray-700 dark:text-gray-300 mr-3">
 {key}
 </div>
 ...
 className="text-sm px-4 py-2 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors font-medium"
 >
 Show Answer / Hints
 </button>
 ) : (
 <div className="p-4 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800/40 rounded-lg">
