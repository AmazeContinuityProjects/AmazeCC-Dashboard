...
export default function QuestionsManager() {
 ...
 className="w-full pl-10 pr-4 py-2.5 rounded-xl border bg-white/80 dark:bg-slate-800/80 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 border-gray-200/50 dark:border-gray-700/50 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-xs" 
 value={searchQuery} 
 ...
 <div className="bg-white dark:bg-slate-900 border dark:border-slate-800 rounded-3xl p-6 max-w-sm w-full shadow-2xl space-y-4">
 ...
 <h4 className="text-sm font-bold text-gray-800 dark:text-gray-250 ">No questions found</h4>
 <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Adjust search query or filters.</p>
 </div>
 ) : (
 <div className="space-y-4">
 {/* Header Checkbox */}
 <div className="flex items-center gap-4 px-5 py-2.5 bg-gray-50/50 dark:bg-slate-900/50 rounded-xl border border-gray-150 dark:border-slate-800/80 ">
 <input 
 type="checkbox" 
 ...
 />
 <span className="text-xs font-semibold text-gray-600 dark:text-gray-400 ">Select All Filtered</span>
 </div>
 ...
 <span className="text-gray-400 dark:text-gray-400 text-xs font-semibold">
 {q.course_code}
 </span>
 <span className="text-gray-300 dark:text-gray-800">&bull;</span>
 <span className="text-gray-500 dark:text-gray-400 text-[10px] font-semibold tracking-wider uppercase">
 {q.question_type}
 </span>
 <span className="text-gray-300 dark:text-gray-800">&bull;</span>
 ...
 <div className="pt-2 flex flex-wrap gap-x-4 gap-y-2 border-t border-gray-100 dark:border-slate-800/80 text-[11px] text-gray-500 dark:text-gray-400 ">
 {q.metadata?.module && (
 <span>
 <strong className="text-gray-400 dark:text-gray-400 uppercase tracking-wider font-semibold mr-1">Module:</strong> 
 <span className="text-gray-700 dark:text-gray-300 ">{q.metadata.module}</span>
 </span>
 )}
 {q.topic_name && (
 <span>
 <strong className="text-gray-400 dark:text-gray-400 uppercase tracking-wider font-semibold mr-1">Topic:</strong> 
 <span className="text-gray-700 dark:text-gray-300 ">{q.topic_name}</span>
 </span>
 )}
