...
export default function SplitScreenReview({ paper, onClose, onPublishSuccess }: SplitScreenReviewProps) {
 ...
 return (
 <div className="fixed inset-0 z-50 bg-gray-50 dark:bg-gray-950 flex flex-col h-screen overflow-hidden">
 {/* Ambient Background Glows */}
 <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
 <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-blue-400/10 dark:bg-blue-500/10 blur-[120px]" />
 <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-emerald-400/10 dark:bg-emerald-500/10 blur-[120px]" />
 </div>

 {/* Top Header */}
 <header className="h-20 shrink-0 bg-white/70 dark:bg-slate-900/80 backdrop-blur-2xl border-b border-gray-200/50 dark:border-gray-800/50 px-8 flex items-center justify-between shadow-xl">
 <div className="flex items-center gap-6">
 <button 
 onClick={onClose} 
 className="p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-xl text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all active:scale-90"
 >
 <ArrowLeft className="w-5 h-5" />
 </button>
 <div className="h-10 w-px bg-gray-200/50 dark:border-gray-800/50 " />
 <div>
 ...
 <div className="w-full lg:w-1/2 h-1/2 lg:h-full border-r border-gray-200/50 dark:border-gray-800/50 flex flex-col bg-gray-50/50 dark:bg-slate-950/40 ">
 <div className="px-6 py-3 border-b border-gray-200/50 dark:border-gray-800/50 text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
 ...
 <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col bg-white/30 dark:bg-slate-900/30 backdrop-blur-sm">
 <div className="px-6 py-3 border-b border-gray-200/50 dark:border-gray-800/50 text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center justify-between">
