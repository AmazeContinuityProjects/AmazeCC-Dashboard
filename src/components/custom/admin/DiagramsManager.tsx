...
export default function DiagramsManager() {
 ...
 className="w-full pl-10 pr-4 py-2.5 rounded-xl border bg-white/80 dark:bg-slate-800/80 text-gray-900 dark:text-gray-100 placeholder-gray-400 border-gray-200/50 dark:border-gray-700/50 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-xs" 
 value={searchQuery} 
