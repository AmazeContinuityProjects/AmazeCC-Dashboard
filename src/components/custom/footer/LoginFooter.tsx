...
export default function LoginFooter() {
 ...
 <Button
 variant="ghost"
 className="mt-2 w-18 h-6 underline text-xs text-gray-500 dark:text-gray-400 "
 ...
 <Button
 variant="ghost"
 className="mt-2 ml-1 w-22 h-6 underline text-xs text-gray-500 dark:text-gray-400 "
