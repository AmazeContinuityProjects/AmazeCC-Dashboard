...
export default function GPAPredictorTab({ marksData, attendance, setActiveSubTab }) {
 ...
 <button onClick={() => setActiveSubTab("overview")} className="p-2 rounded-full bg-white dark:bg-slate-800 shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-100">
 <ChevronLeft size={20} />
 </button>
 <div>
 ...
 <Card className="bg-white dark:bg-slate-900 shadow-sm min-w-0">
 <CardHeader className="pb-3 border-b dark:border-slate-800 min-w-0">
 ...
 className="flex-1 min-w-0 px-4 py-2 border rounded-lg bg-white dark:bg-slate-800 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
 />
 <button
 onClick={saveGoal}
 ...
 <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 rounded-xl mb-6 min-w-0 gap-2">
 ...
 <div key={course.baseCode} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
 ...
 className="px-3 py-2 rounded-md border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 font-semibold text-center focus:ring-2 focus:ring-purple-500 outline-none"
 >
