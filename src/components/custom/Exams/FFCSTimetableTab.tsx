...
export default function FFCSTimetableTab() {
 ...
 {/* Timetable Manager */}
 <div className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
 ...
 * For embedded courses, you must manually add the Theory slot and Lab slot separately to select the exact slots you want.
 ...
 {courses.length > 0 && (
 <div className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] overflow-x-auto">
