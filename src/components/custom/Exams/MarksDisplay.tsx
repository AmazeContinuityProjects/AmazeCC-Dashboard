...
export default function MarksDisplay({ data }) {
 ...
 className="p-4 rounded-2xl shadow-sm bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all"
 ...
 <div className="px-2.5 py-1 flex items-center justify-center bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 text-[10px] uppercase font-bold tracking-wider rounded-md">
 {courseType}
 </div>
 {predictedGrade !== "?" && (
 <div className="px-2.5 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-[10px] font-bold tracking-wider rounded-md">
 Pred: {predictedGrade}
 </div>
 )}
 </div>
 ...
 className="text-gray-800 dark:text-gray-200 drop-shadow-sm"
 />
 </div>
 </div>
 </motion.div>
...
function AssessmentCard({ detail, typeLabel, aStat, isRelative }) {
 ...
 return (
 <div 
 className="bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden cursor-pointer transition-colors hover:bg-gray-100 dark:hover:bg-slate-800 "
 onClick={() => setExpanded(!expanded)}
 >
 <div className="p-4 flex flex-col justify-between">
 <div className="flex justify-between items-start mb-2">
 <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider line-clamp-2 leading-tight flex-1">
 {shortenedTitle}
 </p>
 ...
 className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-900 p-4"
 >
...
function MarksSubpage({ group, allStats, onBack }) {
 ...
 return (
 <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 shadow-sm mt-6">
 <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
 <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
 {icon} {typeLabel} Assessments
 </h3>
 <div className="flex items-center justify-between md:justify-end gap-3">
 <div className={`px-3 py-1 font-bold text-sm rounded-full border ${typeLabel === 'Theory' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800/50 ' : 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800/50 '}`}>
 ...
 <div>
 <h1 className="text-xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 leading-tight">
 {group.courseCode}
 </h1>
 ...
 <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-4 shadow-sm text-center">
 ...
 <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm mt-6">
 ...
 <div className="flex-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center">
 ...
 className="px-3 py-1.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-100 font-bold"
 >
