...
export default function AcademicsHub({ setActiveSubTab, data, marksData, gradesData, attendance, hideMobileHeader, handleFetchGrades }) {
 ...
 className="flex items-center p-4 bg-white/60 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] transition-all duration-300 cursor-pointer group"
 >
 ...
 <div>
 {hideMobileHeader && (
 <Card className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm mb-8">
 ...
 <div 
 className="border-t border-gray-200 dark:border-gray-800 pt-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-800/50 rounded-b-lg transition-colors p-2 -mx-2 -mb-2"
 ...
 return (
 <div key={sem} className="flex justify-between items-center p-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-slate-800/50 ">
 <div>
