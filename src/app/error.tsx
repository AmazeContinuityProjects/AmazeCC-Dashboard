...
export default function ErrorPage({
  ...
  return (
    <main className="min-h-screen w-full bg-gray-50 dark:bg-gray-900 midnight:bg-black px-4 text-gray-900 dark:text-gray-100 flex items-center justify-center py-10">
      <div className="w-full max-w-2xl bg-white/60 dark:bg-slate-900/60 midnight:bg-white/[0.03] backdrop-blur-2xl border border-gray-200/50 dark:border-gray-700/50 midnight:border-white/10 rounded-2xl shadow-xl p-8 space-y-6">
        <div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href="/"
            className="px-4 py-2 text-sm font-semibold rounded-xl border border-gray-200/50 dark:border-gray-700/50 midnight:border-white/10 hover:bg-gray-100 dark:hover:bg-slate-800 midnight:hover:bg-white/[0.06] text-gray-700 dark:text-gray-200 midnight:text-gray-100 transition-colors"
          >
            Go to dashboard
          </Link>
          <button
