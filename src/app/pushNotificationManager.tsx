...
export default function PushNotificationManager() {
 ...
 apiFetch(`/api/notifications/status?UserID=${UserID}`)
 .then(res => res.json())
 .then(data => {
 ...
 {subscription && (
 <div className="mt-3 flex flex-col gap-4 p-4 border border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-900/50 ">
 {/* Vitol */}
 ...
 <select 
 className="text-sm flex-1 p-2 rounded-md border border-gray-300 dark:border-gray-700 bg-transparent "
